...
完整阅读顺序、单一事实来源和文档更新规则见[项目文档索引](项目文档/README.md)。正式文档包括：

- [项目需求与技术方案](项目文档/项目需求与技术方案.md)：当前产品范围、角色边界与技术方案。
- [本地运行与演示指南](项目文档/本地运行与演示指南.md)：启动、演示、备份与排障。
- [数据库设计说明](项目文档/数据库设计说明.md)与[数据库规范化说明](项目文档/数据库规范化说明.md)：物理模型、迁移、约束与范式论证。
- [AI 与 OCR 开发说明](项目文档/AI与OCR开发说明.md)：接口、SSE、状态机与并发规则。
- [测试报告](项目文档/测试报告.md)：当前自动化基线、CI 和验收矩阵。
- [开发记录与上下文归档](项目文档/开发记录与上下文归档.md)：历史里程碑、发布记录、交付物差异与维护约定。
