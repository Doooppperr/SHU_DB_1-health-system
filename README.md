...
演示快照包含 25 个账号、5 个机构主体、15 家分院、25 个套餐、40 个预约组、56 位预约参与者、50 份已归档体检报告、120 条日常测量、15 个私有报告附件和 15 张分院封面。5 个普通用户分别承担不同现实生活场景，机构账号可验证本院生产、兄弟分院归档只读和跨机构拒绝。完整账号矩阵见[测试账号与演示数据](项目文档/测试账号与演示数据.md)。
...
当前验收基线：后端 53 项、前端 100 项测试通过，Vite production build 通过；SQLite/openGauss v8 结构、v7→v8 升级、演示数据预检与覆盖流程已验证。
