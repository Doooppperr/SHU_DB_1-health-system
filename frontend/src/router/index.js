...
const routes = [
  ...
  { path: "/workspace", component: WorkspaceLayout, meta: userMeta, children: [
    ...
    { path: "/health-data", name: "health-data", component: () => import("../views/HealthDataView.vue"), meta: { title: "健康数据" } },
    { path: "/health-data/:id", name: "health-data-detail", component: () => import("../views/HealthDataDetailView.vue"), meta: { title: "健康数据详情" } },
